...
import { sortTasksAlphabetically, showImportantTasks } from '../../reducers/featuresSlice';
...
export default function Menu() {
    ...
    return (
        <Box
            ...
            <main>
                <ul className='menu_list'>
                    ...
                    <ListItem
                        ...
                        mr='25px'
                        text="Important"
                        icon={<StarOutlineOutlinedIcon sx={{
                            fontSize: 25,
                            color: 'icons.primary'
                        }} />} />
                    <ListItem
            ...
            >
                <Box
                    sx={{ backgroundColor: '#FAF9F8', width: '280px', display: 'flex', gap: '30px' }}>
                    <List>
                        <ListItemButton
                        ...
                        <ListItemButton
                            onClick={() => {
                                ...
                                for (let i = 0; i < tasks.length; i++) {
                                    request(`http://localhost:3001/tasks/${tasks[i].id}`, 'DELETE');
                                }
                            }}
                            divider={true}>
                            <ListItemIcon>
